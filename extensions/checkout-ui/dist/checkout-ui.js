...
${errorInfo.componentStack}`);
  ...
  // extensions/checkout-ui/node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/hooks/capabilities.mjs
  ...
  // extensions/checkout-ui/node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/hooks/buyer-journey.mjs
  ...
  function App() {
    const ageTarget = 18;
    const [age, setAge] = (0, import_react11.useState)("");
    ...
    useBuyerJourneyIntercept(({ canBlockProgress: canBlockProgress2 }) => {
      ...
      if (canBlockProgress2 && !isAgeValid()) {
        return {
          behavior: "block",
          ...
          errors: [
            {
              ...
              message: "\u3042\u306A\u305F\u306F\u6CD5\u7684\u306B\u30AB\u30FC\u30C8\u5185\u306E\u5546\u54C1\u3092\u8CFC\u5165\u3067\u304D\u308B\u5E74\u9F62\u306B\u9054\u3057\u3066\u3044\u307E\u305B\u3093"
            }
          ]
        };
      }
